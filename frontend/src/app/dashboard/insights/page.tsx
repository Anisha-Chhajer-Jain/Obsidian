...
=======
            <h3 style={{ margin: "0 0 12px", fontSize: "14px", fontWeight: 600, color: "var(--color-text-primary)", display: "flex", alignItems: "center", gap: "8px" }}>
            ...
            {insights?.recall ? (
              <div className="code-block" style={{ fontSize: "12px", background: "rgba(17,24,39,0.4)", color: "var(--color-text-secondary)", border: "1px solid rgba(255,255,255,0.12)", whiteSpace: "pre-wrap" }}>
                {insights.recall}
              </div>
            ) : (
               <div className="empty-state" style={{ padding: "20px 0" }}>
                 <p style={{ margin: 0, fontSize: "13px", color: "var(--color-text-muted)" }}>No recall data generated yet.</p>
               </div>
>>>>>>> Stashed changes
            )}
          </div>
...
=======
               <div className="empty-state" style={{ padding: "20px 0" }}>
                 <p style={{ margin: 0, fontSize: "13px", color: "var(--color-text-muted)" }}>No reflection data generated yet.</p>
               </div>
>>>>>>> Stashed changes
            )}
          </div>
            ...
            {insights?.routing_suggestion ? (
              <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
               ...
               <div className="empty-state" style={{ padding: "30px 0" }}>
                 ...
                 <p style={{ margin: 0, fontSize: "13.5px", fontWeight: 500, color: "var(--color-text-secondary)" }}>Routing is currently optimal</p>
                 <p style={{ margin: "4px 0 0", fontSize: "12.5px", color: "var(--color-text-muted)" }}>No cost-saving suggestions available at this time.</p>
               </div>
>>>>>>> Stashed changes
            )}
          </div>
