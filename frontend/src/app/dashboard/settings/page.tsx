      ...
      <div className="card" style={{ padding: "24px" }}>
        ...
        <div style={{ display: "grid", gap: "16px" }}>
          <div style={{ padding: "16px", background: "#F7F9F8", borderRadius: "8px", border: "1px solid #E3E8E6" }}>
            <p style={{ margin: "0 0 4px", fontSize: "12px", fontWeight: 600, color: "var(--color-text-muted)", textTransform: "uppercase", letterSpacing: "0.05em" }}>Backend API URL</p>
            <p className="font-mono-data" style={{ margin: 0, fontSize: "14px", color: "#111827" }}>
              {process.env.NEXT_PUBLIC_API_URL || "http://localhost:8000"}
            </p>
            <p style={{ margin: "4px 0 0", fontSize: "12px", color: "var(--color-text-muted)" }}>Configured via environment variables.</p>
          </div>

          <div style={{ padding: "16px", background: "#F7F9F8", borderRadius: "8px", border: "1px solid #E3E8E6" }}>
            <p style={{ margin: "0 0 4px", fontSize: "12px", fontWeight: 600, color: "var(--color-text-muted)", textTransform: "uppercase", letterSpacing: "0.05em" }}>Session Budget Cap</p>
            <p className="font-mono-data" style={{ margin: 0, fontSize: "14px", color: "#111827" }}>{formatINR(0.02, 2)}</p>
            <p style={{ margin: "4px 0 0", fontSize: "12px", color: "var(--color-text-muted)" }}>Fixed policy limit enforced by cascadeflow core.</p>
          </div>
        </div>
      </div>
          ...
          <table className="data-table">
            ...
            <tbody>
              <tr>
                ...
                <td style={{ fontSize: "12px", color: "var(--color-text-muted)" }}>Standard cost/speed balance for common queries.</td>
              </tr>
              <tr>
                <td><span className="badge badge-indigo">refund</span></td>
                <td className="font-mono-data" style={{ fontSize: "12px", color: "#374151" }}>qwen-2.5-32b</td>
                <td style={{ fontSize: "12px", color: "var(--color-text-muted)" }}>Requires accurate reasoning for financial logic.</td>
              </tr>
              <tr>
                ...
                <td style={{ fontSize: "12px", color: "var(--color-text-muted)" }}>High speed, low cost for simple questions.</td>
              </tr>
              <tr>
                ...
                <td style={{ fontSize: "12px", color: "var(--color-text-muted)" }}>Policy violation. Halted before reaching any model.</td>
              </tr>
            </tbody>
          </table>
        </div>
